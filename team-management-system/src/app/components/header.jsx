...
import logo from "../Transparent_Team_Management_System_Logo.png"
    ...
    <div className="bg-gray-100">
      <div className="h-screen flex overflow-hidden bg-gray-200">
        ...
        >
          {/* Sidebar Content */}
          <div className="p-4">
            <link rel="icon" href="/Transparent_Team_Management_System_Logo.png" />
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center w-full max-w-2xl gap-2 mx-auto mt-6">
                <div className="mt-3 rounded-lg sm:mt-0">
                  <button href='Login' className="px-5 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-blue-600 lg:px-10 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Get Started
                  </button>
                </div>
                <div className="mt-3 rounded-lg sm:mt-0">
                ...
                <div className="mt-3 rounded-lg sm:mt-0 sm:ml-3">
                  <button onClick={() => router.push('/Login')} className="items-center block px-5 lg:px-10 py-3.5 text-base font-medium text-center text-blue-600 transition duration-500 ease-in-out transform border-2 border-white shadow-md rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    Create Account
                  </button>
                </div>
              </div>
