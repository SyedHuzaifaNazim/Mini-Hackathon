...
const TeamTypeQuestions = () => {
  ...
  return (
    // <div>
    //   <h1 className='text-4xl flex justify-center'>Team Type Questions</h1>
    ...
    <form>
    <h1 className='text-4xl flex justify-center'>Team Type Questions</h1><br/>
